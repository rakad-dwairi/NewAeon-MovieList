            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-7 col-sm-12">
                    @if(auth()->guard('admin')->user()->hasPermission('create_episodes'))
                        <a href="{{route('dashboard.episodes.create',['seasons_id' => $episodes->id, 'series_id' => $episodes->series_id])}}">
                    ...
                    <ul class="breadcrumb float-md-right">
                        <li class="breadcrumb-item"><a href="{{url('dashboard')}}"><i class="zmdi zmdi-home"></i> episodes</a>
                        </li>
                                        ...
                                        @forelse($episodes->episodes2 as $eposide)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <button class="btn btn-info btn-sm disabled" style="cursor: no-drop">episodes</button>
                                                    @endif
                                                </td>
                                                <td>
                                                    ...
                                                    @if(auth()->guard('admin')->user()->hasPermission('delete_episodes'))
                                                        <form action="{{ route('dashboard.episodes.destroy', $eposide) }}"
