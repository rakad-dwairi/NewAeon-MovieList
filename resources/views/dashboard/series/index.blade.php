                                        ...
                                        @forelse($series as $serie)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('dashboard.ratings.index', ['serie' => $serie->id])}}"><small style="font-size: 10px">({{$serie->ratings->count()}} votes)</small></a>
                                                </td>
                                                <td>
                                                    <button title="show overview"
                                                            value="{{$serie->overview}}"
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <button class="btn btn-info btn-sm disabled" style="cursor: no-drop">series</button>
                                                    @endif
                                                </td>
                                                <td>
