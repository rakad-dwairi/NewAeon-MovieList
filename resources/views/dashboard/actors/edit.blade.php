                        ...
                        <div class="body">
                            <form action="{{ route('dashboard.actors.update', $actor) }}" method="POST"
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <textarea name="overview" rows="4" class="form-control no-resize" placeholder="Actor Overview">{{ $actor->overview }}</textarea>
                                            <span
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <textarea name="biography" rows="4" class="form-control no-resize" placeholder="Actor Biography">{{ $actor->biography }}</textarea>
                                            <span
                                                style="color: red; margin-left: 10px">{{ $errors->first('biography') }}</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        ...
                                        <div>
                                            <span class="btn btn-dark btn-file">
                                                ...
                                                <input type="file" name="avatar" value="{{ $actor->avatar }}">
                                            </span>
                                ...
                                <div class="form-group last">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                            <img src="{{ $actor->background_cover }}" alt="" />
                                        </div>
                                        <div class="fileinput-preview fileinput-exists thumbnail"
                                            style="max-width: 200px; max-height: 150px;">
                                        </div>
