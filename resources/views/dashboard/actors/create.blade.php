                        ...
                        <div class="body">
                            <form action="{{ route('dashboard.actors.store') }}" method="POST"
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <textarea name="overview" rows="4" class="form-control no-resize" placeholder="Actor Overview">{{ old('overview', '') }}</textarea>
                                            <span
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <textarea name="biography" rows="4" class="form-control no-resize" placeholder="Actor Biography">{{ old('biography', '') }}</textarea>
                                            <span
