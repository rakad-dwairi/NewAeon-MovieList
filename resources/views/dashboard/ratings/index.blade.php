                                        ...
                                        <tbody>
                                            @forelse($ratings as $rating)
                                                <tr>
                                                    <td>
                                                        <a
                                                            href="{{ route('dashboard.clients.index', ['search' => $rating->user->username]) }}">{{ $rating->user->username }}</a>
                                                    </td>
                                                    <td>
                                                        <a
                                                            href="{{ route('dashboard.films.index', ['search' => $rating->film->name]) }}">{{ $rating->film->name }}</a>
                                                    </td>
                                                    <td><i class="zmdi zmdi-star"></i> {{ $rating->rating }}</td>
                                                    <td>
                                                        @if (auth()->guard('admin')->user()->hasPermission('delete_ratings'))
                                                            <form
                                                                action="{{ route('dashboard.ratings.destroy', $rating) }}"
