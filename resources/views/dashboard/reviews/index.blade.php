                                        ...
                                        <tbody>
                                            @forelse($reviews as $review)
                                                <tr>
                                                    <td>
                                                        <a
                                                            href="{{ route('dashboard.clients.index', ['search' => $review->user->username]) }}">{{ $review->user->username }}</a>
                                                    </td>
                                                    <td>
                                                        <a
                                                            href="{{ route('dashboard.films.index', ['search' => $review->film->name]) }}">{{ $review->film->name }}</a>
                                                    </td>
                                                    <td>
                                                        <button title="show review" value="{{ $review->review }}"
                                                    ...
                                                    <td>
                                                        @if (auth()->guard('admin')->user()->hasPermission('delete_reviews'))
                                                            <form
                                                                action="{{ route('dashboard.reviews.destroy', $review) }}"
