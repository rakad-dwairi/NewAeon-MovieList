                    ...
                    <div class="body">
                        ...
                        <form action="{{ route('dashboard.films.index') }}" method="GET">
                            <div class="row clearfix">
                                ...
                                {{request()->server == $server->id ? 'selected' : ''}}>{{$server->name}}</option>
                                @endforeach
                                </select>
                            </div> --}}
                            <div class="col-3">
                                    ...
                                    <tr>
                                        <td>
                                            <span class="list-icon">
                                                <img src="{{$film->poster}}" alt="" style="width: 50px; height: 50px;">
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('dashboard.ratings.index', ['film' => $film->id])}}"><small
                                                    style="font-size: 10px">({{$film->ratings->count()}}
                                                    votes)</small></a>
                                        </td>
                                        <td>
                                            <button title="show overview" value="{{$film->overview}}"
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('dashboard.films.destroy', $film) }}" method="POST"
