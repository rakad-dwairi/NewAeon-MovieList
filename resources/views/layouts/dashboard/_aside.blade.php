...
<aside id="leftsidebar" class="sidebar">
    <ul class="nav nav-tabs">
        <li class="nav-item"><a class="nav-link active" href="/"><i class="zmdi zmdi-home m-r-5"></i>Films</a></li>
        <li class="nav-item"><a class="nav-link active"
                href="{{ route('dashboard.admins.edit',auth()->guard('admin')->user()) }}"><i
                    class="zmdi zmdi-account-box m-r-5"></i>Profile</a>
        </li>
    </ul>
            ...
            <div class="menu">
                <ul class="list">
                    <li>
                        <div class="user-info">
                            <div class="image"><a href=""><img
                                        src="{{ auth()->guard('admin')->user()->avatar }}" alt="User"></a></div>
                            <div class="detail">
                    ...
                    @if (auth()->guard('admin')->user()->hasPermission('read_admins'))
                        <li>
                            <a href="javascript:void(0);" class="menu-toggle"><i
                                    class="zmdi zmdi-account"></i><span>Admins</span>
                            </a>
                            <ul class="ml-menu">
                    ...
                    @if (auth()->guard('admin')->user()->hasPermission('read_clients'))
                        <li>
                            <a href="javascript:void(0);" class="menu-toggle"><i
                                    class="zmdi zmdi-account-circle"></i><span>Clients</span>
                            </a>
                            <ul class="ml-menu">
                    ...
                    @if (auth()->guard('admin')->user()->hasPermission('read_categories'))
                        <li>
                            <a href="javascript:void(0);" class="menu-toggle"><i
                                    class="zmdi zmdi-view-list"></i><span>Categories</span>
                            </a>
                            <ul class="ml-menu">
                    ...
                    @if (auth()->guard('admin')->user()->hasPermission('read_servers'))
                        <li>
                            <a href="javascript:void(0);" class="menu-toggle"><i
                                    class="zmdi zmdi-view-agenda"></i><span>Servers</span>
                            </a>
                            <ul class="ml-menu">
                    ...
                    @if (auth()->guard('admin')->user()->hasPermission('read_films'))
                        <li>
                            <a href="javascript:void(0);" class="menu-toggle"><i
                                    class="zmdi zmdi-movie"></i><span>Films</span>
                            </a>
                            <ul class="ml-menu">
                    ...
                    @if (auth()->guard('admin')->user()->hasPermission('read_series'))
                        <li>
                            <a href="javascript:void(0);" class="menu-toggle"><i
                                    class="zmdi zmdi-movie-alt"></i><span>series</span>
                            </a>
                            <ul class="ml-menu">
                    ...
                    @if (auth()->guard('admin')->user()->hasPermission('read_actors'))
                        <li>
                            <a href="javascript:void(0);" class="menu-toggle"><i
                                    class="zmdi zmdi-male"></i><span>Actors</span>
                            </a>
                            <ul class="ml-menu">
                    ...
                    @if (auth()->guard('admin')->user()->hasPermission('read_ratings'))
                        <li>
                            <a href="javascript:void(0);" class="menu-toggle"><i
                                    class="zmdi zmdi-star"></i><span>Ratings</span>
                            </a>
                            <ul class="ml-menu">
                    ...
                    @if (auth()->guard('admin')->user()->hasPermission('read_reviews'))
                        <li>
                            <a href="javascript:void(0);" class="menu-toggle"><i
                                    class="zmdi zmdi-comment-list"></i><span>Reviews</span>
                            </a>
                            <ul class="ml-menu">
                    ...
                    @if (auth()->guard('admin')->user()->hasPermission('read_messages'))
                        <li>
                            <a href="javascript:void(0);" class="menu-toggle"><i
                                    class="zmdi zmdi-email"></i><span>Messages</span>
                            </a>
                            <ul class="ml-menu">
